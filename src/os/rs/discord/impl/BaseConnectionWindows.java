...
class BaseConnectionWindows extends BaseConnection {
	...
	public void register(String applicationId, String command) {
		...
		String javaExePath = javaExeFile.exists() ? javaExeFile.getAbsolutePath()
	...
	public void registerSteamGame(String applicationId, String steamId) {
		try {
			String steamPath = WinRegistry.readString(WinRegistry.HKEY_CURRENT_USER, "Software\\\\Valve\\\\Steam",
					"SteamExe");
			if (steamPath == null)
