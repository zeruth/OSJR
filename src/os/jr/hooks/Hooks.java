...
public class Hooks {
	...
	public DynamicObject dynamicObject = new DynamicObject(null);
	public Enum enum_ = new Enum();
	public Enumerated enumerated = new Enumerated();
	public FaceNormal faceNormal = new FaceNormal(null);
	...
	public GameEngine gameEngine = new GameEngine(null);
	...
	public UrlRequester urlRequester = new UrlRequester(null);
