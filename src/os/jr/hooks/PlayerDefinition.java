...
public class PlayerDefinition extends GameClass{
	...
	public PlayerDefinition() {
		...
		//this.fields.put("PlayerDefinition_AnimatedModelID", new GameField("v", playerDefinition, 67463743691277787));
		//this.fields.put("PlayerDefinition_ModelID", new GameField("m", playerDefinition, -3780734730102732469));
