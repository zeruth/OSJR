...
public class HookDebugger {
	...
	public static void updateValues() {
		if (lblWeightdata != null) {
			...
			lblEnergydata.setText("" + energy);
			lblWorld.setText("" + world);
			String[] lvls = intArraytoString(levels);
			String[] xp = intArraytoString(experiences);
	...
	public static int makePbarMax(int skill) {
		return (getXPforNextLevel(levels[skill])-getXPforCurrentLevel(levels[skill]));
	}
	
	public static int makePbarSelection(int skill) {
		return (experiences[skill]-getXPforCurrentLevel(levels[skill]));
	}
}
