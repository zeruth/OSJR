	...
	public void init() {
		...
		this.confirm.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				Color newColor = new Color(ColorChooserApplet.this.r, ColorChooserApplet.this.g,
						ColorChooserApplet.this.b);
		...
		/*
		 * Set background colors for Scrollbars and Labels, so they don't inherit the
		...
		/*
		 * Create a canvas whose background color will always be set to the currently
		 * selected color.
		 */
		...
		/*
		 * Create the applet format, which consists of a row of three equal-sized
		 * regions holding the Scrollbars, the Labels, and the color patch. The
		 * background color of the applet is gray, which will show around the edges and
		 * between components.
		 */
