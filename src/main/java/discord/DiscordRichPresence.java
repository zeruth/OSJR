...
public class DiscordRichPresence {
	...
	public static class DiscordRichPresenceBuilder {
		...
		public DiscordRichPresence build() {
			return new DiscordRichPresence(this.state, this.details, this.startTimestamp, this.endTimestamp,
					this.largeImageKey, this.largeImageText, this.smallImageKey, this.smallImageText, this.partyId,
					this.partySize, this.partyMax, this.matchSecret, this.joinSecret, this.spectateSecret,
					this.instance);
		}
	...
	JsonObject toJson(long pid, long nonce) {
		...
		if ((this.getPartyId() != null && !this.getPartyId().isEmpty()) || this.getPartySize() != 0
				|| this.getPartyMax() != 0) {
